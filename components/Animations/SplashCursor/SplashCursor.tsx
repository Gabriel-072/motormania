...
export default function SplashCursor({
  SIM_RESOLUTION    =  32,    // antes 128
  DYE_RESOLUTION    = 256,    // antes 1440
  CAPTURE_RESOLUTION= 128,    // antes 512
  DENSITY_DISSIPATION  = 10,
  VELOCITY_DISSIPATION = 0.5,
  PRESSURE           = 0.1,
  PRESSURE_ITERATIONS =  8,   // antes 20
  CURL               =  1,    // antes 3
  SPLAT_RADIUS       = 0.1,
  SPLAT_FORCE        = 1000,  // antes 6000
  SHADING            = false, // desactivado
  ...
  useEffect(() => {
    ...
    function generateColor() {
      const palette = [
        { r:245/255, g:158/255, b:11/255 },  // amber
        { r:34/255,  g:211/255, b:238/255 }, // cyan
        { r:147/255, g:51/255,  b:234/255 }  // purple
      ];
